...
- **キネティック・タイポグラフィ**: **16種のレタリング** (ネオン/アウトライン/マーカー/筆/クローム/ロングシャドウ/ゴールド/2色グラデ/レインボー/ファイア/アイス/3D押し出し/グリッチ(RGBずれ)/レトロ80s/ステッカー/ピル)、**18種の出現アニメ** (グロウポップ/フェード/スライド/ポップ/グリッチ/ズーム/ドロップ弾み/ふわり上昇/スピン/フリップ/スイング/ブラー/ストレッチ/タイプライター/カスケード/ウェーブ/タンブル ほか。一字ずつ入場する系も対応)、**縦書き(tategaki)対応**、字間調整、多層グロー + easeOutBack + 発声脈動。**出現アニメは曲全体でも、Intro/Verse/Chorus などシーンごとにも変更可(シーン解析AI後)**
